...
export type FilterGetters<E extends Element, F extends Filters<E>> = {
  [P in keyof F]:
...
export interface InteractorBuilder<E extends Element, FP extends FilterParams<any, any>, AM extends ActionMethods<any, any>, FG extends FilterGetters<any, any>> {
  ...
  extend<ER extends E = E>(name: string): InteractorConstructor<ER, FP, AM, FG>;
}
...
export interface InteractorConstructor<
  ...
  FG extends FilterGetters<any, any>
> extends InteractorBuilder<E, FP, AM, FG> {
  /**
   ...
   */
  (filters?: FP): Interactor<E, FP> & AM & FG;
  /**
   ...
   * @param filters An object describing a set of filters to apply, which should match the value of applying the filters defined in the {@link InteractorSpecification} to the element.
   */
  (value: MaybeMatcher<string>, filters?: FP): Interactor<E, FP> & AM & FG;
}
...
export interface InteractorSpecificationBuilder<E extends Element> extends InteractorBuilder<E, EmptyObject, EmptyObject, EmptyObject> {
  ...
  <F extends Filters<E> = EmptyObject, A extends Actions<E> = EmptyObject>(specification: InteractorSpecification<E, F, A>): InteractorConstructor<E, FilterParams<E, F>, ActionMethods<E, A>, FilterGetters<E, F>>;
}
