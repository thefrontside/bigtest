...
export type ActionFn<E extends Element> = (interactor: InteractorInstance<E, EmptyObject, EmptyObject>, ...args: any[]) => Promise<unknown>;
...
export type ActionMethods<E extends Element, A extends Actions<E>> = {
  [P in keyof A]: A[P] extends ((interactor: InteractorInstance<E, EmptyObject, EmptyObject>, ...args: infer TArgs) => Promise<infer TReturn>)
